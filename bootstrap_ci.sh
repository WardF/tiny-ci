...
if [ `which apt-get | wc -w` -gt 0 ]; then
    ...
    PKG_LIST="ubuntu-dev-tools m4 git libjpeg-dev libcurl4-openssl-dev wget htop libtool bison flex autoconf curl g++ midori gfortran cmake-data emacs zip gdb valgrind"
    GRP_LIST=""
