...
FIND_PROGRAM(CC_MPI NAMES mpicc)
FIND_PROGRAM(FC_MPI NAMES mpif90)
...
FIND_PROGRAM(CC_MPICC mpicc)
SET(CTEST_MPICC_CMD ${CC_MPICC})
## Set CTest Options
set(OPTIONS -DCMAKE_PREFIX_PATH=/home/vagrant/local2 -DNC_CTEST_DROP_SITE=${CTEST_DROP_SITE} -DNC_CTEST_DROP_LOC_PREFIX=/CDash -DTEST_PARALLEL=ON -DCMAKE_C_COMPILER=${CC_MPI} -DCMAKE_Fortran_COMPILER=${FC_MPI})
